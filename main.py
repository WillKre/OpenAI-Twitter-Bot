...
class OpenAIBot:
    def __init__(self, bot_name, chat_gpt_model, prompt_prefix, aws_secret_name, aws_dynamodb_table_name):
        # AWS Config
...
if __name__ == "__main__":
    ...
    prompt_prefix = "Summarise/Explain in a condensed way the following content in one or two short sentences with a total of no more than 200 characters:"

    # Specify AWS resource names
    aws_secret_name='summarise-gpt-prod'
    aws_dynamodb_table_name='summarise-gpt-tweet-replies'

    # Use Bot
    bot = OpenAIBot(bot_name, chat_gpt_model, prompt_prefix, aws_secret_name, aws_dynamodb_table_name)
